...
public class AppStoreMainOptions {
    ...
    public static final String USAGE_API_BASE = "The server's API base URI. Default is http://127.0.0.1:4003/api";
    ...
    @Getter @Setter private String apiBase = "http://127.0.0.1:4003/api";
