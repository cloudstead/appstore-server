...
public class PagedAppStoreMainOptions extends AppStoreMainOptions {
    ...
    public ResultPage getPage () { return new ResultPage(pagenum, pagesize, null, null, filter, null); }
